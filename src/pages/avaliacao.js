    ...
    <Layout>
      ...
      <article className="card-body">
        ...
        <p data-aos="zoom-in">
          ...
          comportamentos que serão alvos da intervenção ABA intensiva. Alguns
          deles são: VB-MAPP, ABLA, ABLLS.
        </p>
        <p data-aos="zoom-in">
          Os principais ambientes em que observamos os comportamentos da criança
          são: consultório, casa e escola. No consultório, o analista do
          comportamento tem a possibilidade de observar os comportamentos da
          criança de forma mais estruturada e controlada, estabelecendo
          estratégias e condições do ambiente para examinar se e de que maneira
          a criança responde a determinados estímulos.
        </p>
        <p data-aos="zoom-in">
          A avaliação na casa da criança prioriza a observação dos
          comportamentos em sua rotina habitual, nas interações com pessoas
          desse ambiente e nas principais situações do dia a dia. Nesse ambiente
          também temos a oportunidade de observar as principais habilidades já
          adquiridas pela criança, bem como suas principais dificuldades. São
          observados comportamentos como: interação, comunicação, manejo de
          brinquedos e habilidades relacionadas ao brincar, autonomia nas
        ...
        <p data-aos="zoom-in">
          ...
          ambiente, habilidades relacionadas à autonomia e seguimento da rotina
          escolar, habilidades relacionadas ao desempenho acadêmico, principais
          dificuldades etc.
        </p>

        <p data-aos="zoom-in">
          O processo de avaliação comportamental inicial só é finalizado depois
          de sistematizadas as informações sobre os comportamentos-alvos obtidas
          nos três ambientes: consultório, casa e escola. Eventualmente outros
          contextos também podem ser observados como sessões com outros
          profissionais que trabalham com a criança. Ao término desse processo
          são fechadas as metas iniciais de intervenção e combinado com a equipe
          (família, profissionais, escola) os procedimentos e estratégias que
          serão aplicados.
        </p>
        <p data-aos="zoom-in">
          A avaliação comportamental é um processo contínuo, inerente a todo o
          período de intervenção ABA intensiva. Pode e deve ser realizada ao
          primeiro sinal de atraso de desenvolvimento da criança.
        </p>
      </article>
      {/* <Card>
        <Card.Body>
